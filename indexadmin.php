...
<head>
    ...
    <title>Admin Perpustakaan SMKN 1 Pungging</title>
	<!-- BOOTSTRAP STYLES-->
...
float: right;
font-size: 16px;"> SMKN 1 Pungging &nbsp; <a href="logout.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        </nav>   
           <!-- /. NAV TOP  -->
